...
#ifndef __conv2d_accel_mac_cud__HH__
#define __conv2d_accel_mac_cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv2d_accel_mac_cud) {
    ...
    SC_CTOR(conv2d_accel_mac_cud):  simcore_mac_0_U ("simcore_mac_0_U") {
