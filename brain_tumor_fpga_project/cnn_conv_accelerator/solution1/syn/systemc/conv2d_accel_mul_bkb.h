...
#ifndef __conv2d_accel_mul_bkb__HH__
#define __conv2d_accel_mul_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv2d_accel_mul_bkb) {
    ...
    SC_CTOR(conv2d_accel_mul_bkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
