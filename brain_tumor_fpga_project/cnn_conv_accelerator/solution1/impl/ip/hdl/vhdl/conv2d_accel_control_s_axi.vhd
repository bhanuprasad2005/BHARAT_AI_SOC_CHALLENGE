...
entity conv2d_accel_control_s_axi is
generic (
...
end entity conv2d_accel_control_s_axi;
...
architecture behave of conv2d_accel_control_s_axi is
    ...
    constant ADDR_KERNEL_V_DATA_0 : INTEGER := 16#18#;
    constant ADDR_KERNEL_V_CTRL   : INTEGER := 16#1c#;
    constant ADDR_BIAS_V_DATA_0   : INTEGER := 16#20#;
    constant ADDR_BIAS_V_CTRL     : INTEGER := 16#24#;
    constant ADDR_OUTPUT_V_DATA_0 : INTEGER := 16#28#;
    constant ADDR_OUTPUT_V_CTRL   : INTEGER := 16#2c#;
